...
Vue.component("editTabel", {
  ...
  methods: {
    ...
    changeOnServer: function (event) {
      ...
      axios
        .post("../vendor/saveTabel.php", JSON.stringify(this.tabel))
        .then((res) => {
    ...
    exportToExcel: function (id) {
      ...
      tableToExcel(
        ...
        "Табель вывод" + this.range[0] + "-" + this.range[this.range.length - 1]
      );
    },
